...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/09 08:43:20 by mashad            #+#    #+#             */
/*   Updated: 2022/02/09 08:43:25 by mashad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	INKSERVERCONFIG *getServerConfig() const
	{
		return (this->_inkweConfig);
	}
		...
		while (std::getline(data, line))
		{
			...
			else
			{
				...
				case 'd':
				{
					...
					this->_inkweConfig[ServersCounter].setDefaultErrorPage(std::strtok(&line[std::strlen("default_error_pages=")], ";"));
					break;
				}
				case 'b':
				{
