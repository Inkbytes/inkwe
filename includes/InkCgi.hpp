...
/*   Updated: 2022/02/09 08:43:08 by mashad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class InkCgi
{
    ...
    public:
        InkCgi(request req, INKSERVERCONFIG serverConf)
        {
			if (req.getPath() == "/")
				scriptName = serverConf.getInkLocation()->getRoot() + req.getPath()+req.getScriptName();
			else
				scriptName = serverConf.getInkLocation()->getRoot() + req.getPath()+ "/" + req.getScriptName();
        ...
        void init_env(request req, INKSERVERCONFIG serverConf)
        {
